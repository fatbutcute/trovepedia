export const leaderboardContent = {
  en: {
    ...
    description: "Explore the top-ranked players across every leaderboard and see how the rankings change over time. \nData is captured hourly, with 7 days of live history available alongside a complete archive of past rankings.",
    categories: {
    ...
    loading: "Fetching leaderboard records...",
    error: "Failed to load leaderboard data from server.",
